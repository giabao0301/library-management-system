...
public class Dashboard extends javax.swing.JFrame {
    ...
    public void showPieChart() {
        ...
        try {
            ...
            String sql = "select book_name, count(*) as issue_count from issue group by book_name";
    ...
    public List<Student> getStudents() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select student_id, student_name, count(*) as issuedBooks from issue group by student_id, student_name");
    ...
    public List<Book> getBooks() {
        ...
        try {
            Connection conn = DBConnection.getConnection();
            Statement st = conn.createStatement();
            ResultSet rs = st.executeQuery("select book_id, book_name, count(*) as issuedBooks from issue group by book_id, book_name");
    ...
    public void setStudentToTable() {
        ...
        for (Student st : students) {
            Object[] obj = {st.getId(), st.getName(), st.getIssuedBooks()};
    ...
    public void setBookToTable() {
        ...
        for (Book b : books) {
            Object[] obj = {b.getId(), b.getTitle(), b.getIssuedQuantity()};
